...
namespace Proyecto_Lab_SAGP_DAAA
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.Write("Coloque la capacidad del parqueo: ");
                capacidadParqueo = int.Parse(Console.ReadLine());

                if (capacidadParqueo < 10)
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("Error: Capacidad mínima de 10");
                    Console.ResetColor();
                }
                ...
                switch (opcion)
                {
                    ...
                    case 2:
                        ...
                        else
                        {
                            ...
                            minutosEstacionados = int.Parse(Console.ReadLine());
